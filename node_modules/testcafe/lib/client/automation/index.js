			...
			"client": {
				"automation": {
					...
					"playback": {
							...
							"event-sequence": {
								"base.js": function (exports, module, require) {
									...
									var MoveEventSequenceBase = function () {
									    function MoveEventSequenceBase(_ref) {
									    ...
									    MoveEventSequenceBase.prototype.move = function move() /* element, options */{};
									    ...
									    MoveEventSequenceBase.prototype.teardown = function teardown() /* currentElement, eventOptions, prevElement */{};

									    MoveEventSequenceBase.prototype.run = function run(currentElement, prevElement, options, dragElement, dragDataStore) {
									        ...
									        if (browserUtils.isIE) this.move(currentElement, options);
								...
								"create-event-sequence.js": function (exports, module, require) {
									

									exports.__esModule = true;
									exports.default = createEventSequence;

									var _moveEventSequence = require('./move-event-sequence');

									var _moveEventSequence2 = _interopRequireDefault(_moveEventSequence);

									var _dragAndDropMove = require('./drag-and-drop-move');

									var _dragAndDropMove2 = _interopRequireDefault(_dragAndDropMove);

									var _dragAndDropFirstMove = require('./drag-and-drop-first-move');
									...
									function createEventSequence(dragAndDropEnabled, firstMovingStepOccured, options) {
									    if (!dragAndDropEnabled) return new _moveEventSequence2.default(options);

									    if (firstMovingStepOccured) return new _dragAndDropMove2.default(options);

									    return new _dragAndDropFirstMove2.default(options);
									}
									module.exports = exports['default'];
								},
								"drag-and-drop-first-move.js": function (exports, module, require) {
									...
									var _eventBehaviors = require('./event-behaviors');
									...
									var DragAndDropFirstMoveEventSequence = function (_MoveEventSequenceBas) {
									    ...
									    DragAndDropFirstMoveEventSequence.prototype.leaveElement = function leaveElement(currentElement, prevElement, commonAncestor, options) {
									        _eventBehaviors.MoveBehaviour.leaveElement(currentElement, prevElement, commonAncestor, options);
									    };

									    DragAndDropFirstMoveEventSequence.prototype.move = function move(element, option) {
									        _eventBehaviors.MoveBehaviour.move(this.moveEvent, element, option);
									    };

									    DragAndDropFirstMoveEventSequence.prototype.enterElement = function enterElement(currentElement, prevElement, commonAncestor, options) {
									        _eventBehaviors.MoveBehaviour.enterElement(currentElement, prevElement, commonAncestor, options);
									    };
									    ...
									    DragAndDropFirstMoveEventSequence.prototype.dragAndDrop = function dragAndDrop(dragElement, currentElement, prevElement, options, dragDataStore) {
									        ...
									        this.dropAllowed = _eventBehaviors.DragAndDropBehavior.dragAndDrop(dragElement, currentElement, prevElement, options);
									    };

									    DragAndDropFirstMoveEventSequence.prototype.run = function run(currentElement, prevElement, options, dragElement, dragDataStore) {
									        return _MoveEventSequenceBas.prototype.run.call(this, currentElement, null, options, dragElement, dragDataStore);
									    };

									    return DragAndDropFirstMoveEventSequence;
									}(_base2.default);

									exports.default = DragAndDropFirstMoveEventSequence;
									module.exports = exports['default'];
								},
								"drag-and-drop-move.js": function (exports, module, require) {
									...
									exports.default = DragAndDropMoveEventSequence;
									module.exports = exports['default'];
								},
								"event-behaviors.js": function (exports, module, require) {
									

									exports.__esModule = true;
									exports.DragAndDropBehavior = exports.MoveBehaviour = undefined;
									...
									var MoveBehaviour = exports.MoveBehaviour = function () {
									    function MoveBehaviour() {
									        _classCallCheck(this, MoveBehaviour);
									    }

									    MoveBehaviour.leaveElement = function leaveElement(currentElement, prevElement, commonAncestor, options) {
									    ...
									    MoveBehaviour.enterElement = function enterElement(currentElement, prevElement, commonAncestor, options) {
									    ...
									    MoveBehaviour.move = function move(moveEvent, element, options) {
									...
									var DragAndDropBehavior = exports.DragAndDropBehavior = function () {
									    function DragAndDropBehavior() {
									        _classCallCheck(this, DragAndDropBehavior);
									    }

									    DragAndDropBehavior.dragAndDrop = function dragAndDrop(dragElement, currentElement, prevElement, options) {
								...
								"move-event-sequence.js": function (exports, module, require) {
									...
									var MoveEventSequence = function (_MoveEventSequenceBas) {
									    ...
									    function MoveEventSequence(options) {
									        ...
									        var _this = _possibleConstructorReturn(this, _MoveEventSequenceBas.call(this, options));
									    ...
									    MoveEventSequence.prototype.move = function move(element, options) {
									        if (this._needEmulateMoveEvent()) _eventBehaviors.MoveBehaviour.move(this.moveEvent, element, options);
									    };

									    MoveEventSequence.prototype.teardown = function teardown(currentElement, eventOptions, prevElement) {
									        ...
									        if (this._needEmulateMoveEvent() && _testcafeCore.domUtils.isElementInDocument(currentElement) && currentElement !== prevElement) eventSimulator[this.moveEvent](currentElement, eventOptions);
									    };

									    MoveEventSequence.prototype._needEmulateMoveEvent = function _needEmulateMoveEvent() {
									...
									exports.default = MoveEventSequence;
									module.exports = exports['default'];
								}
							},
							"index.js": function (exports, module, require) {
								...
								var _createEventSequence = require('./event-sequence/create-event-sequence');

								var _createEventSequence2 = _interopRequireDefault(_createEventSequence);
								...
								var MoveAutomation = function () {
								    ...
								    MoveAutomation.prototype._emulateEvents = function _emulateEvents(currentElement) {
								        ...
								        var eventSequence = (0, _createEventSequence2.default)(this.dragAndDropState.enabled, this.firstMovingStepOccured, eventSequenceOptions);

								        var _eventSequence$run = eventSequence.run(currentElement, lastHoveredElement, eventOptions, this.dragElement, this.dragAndDropState.dataStore),
						...
						"press": {
							...
							"key-press-simulator.js": function (exports, module, require) {
								...
								var _getKeyProperties = require('../../utils/get-key-properties');

								var _getKeyProperties2 = _interopRequireDefault(_getKeyProperties);
								...
								var KeyPressSimulator = function () {
								    ...
								    KeyPressSimulator.prototype._addKeyPropertyToEventOptions = function _addKeyPropertyToEventOptions(eventOptions) {
								        extend(eventOptions, (0, _getKeyProperties2.default)(eventOptions.type === 'keypress', this.keyProperty, this.keyIdentifierProperty));
								    ...
								    KeyPressSimulator.prototype.press = function press(modifiersState) {
								        ...
								        var raiseDefault = browserUtils.isAndroid || eventSimulator.keypress(activeElement, extend(eventOptions, modifiersState));
						...
						"type": {
							"index.js": function (exports, module, require) {
								...
								var TypeAutomation = function () {
								    ...
								    TypeAutomation.prototype._calculateEventArguments = function _calculateEventArguments(isPressEvent) {
								        ...
								        extend(options, (0, _getKeyProperties2.default)(isPressEvent, this.currentKey, this.currentKeyIdentifier));
							...
							"type-text.js": function (exports, module, require) {
								...
								function _updateSelectionAfterDeletionContent(element, selection) {
								    ...
								    var startParent = nativeMethods.nodeParentNodeGetter.call(startNode);
								...
								function _typeTextInElementNode(elementNode, text, offset) {
								    ...
								    var parent = nativeMethods.nodeParentNodeGetter.call(elementNode);

								    if (domUtils.getTagName(elementNode) === 'br') parent.insertBefore(nodeForTyping, elementNode);else if (offset > 0) elementNode.insertBefore(nodeForTyping, elementNode.childNodes[offset]);else elementNode.appendChild(nodeForTyping);
					...
					"utils": {
						...
						"get-key-properties.js": function (exports, module, require) {
							

							exports.__esModule = true;
							exports.default = getKeyProperties;
							function getKeyProperties(isKeyPressEvent, key, keyIdentifier) {
							    var properties = {};

							    if ('keyIdentifier' in KeyboardEvent.prototype) properties.keyIdentifier = isKeyPressEvent ? '' : keyIdentifier;

							    if ('key' in KeyboardEvent.prototype) properties.key = key;
						...
						"utils.js": function (exports, module, require) {
							...
							exports.getElementBoundToLabel = getElementBoundToLabel;
							exports.focusByLabel = focusByLabel;
							...
							function focusAndSetSelection(element, simulateFocus, caretPos) {
							    return new Promise(function (resolve) {
							        ...
							        if (shouldFocusByRelatedElement) {
							            if (simulateFocus) focusByLabel(labelWithForAttr);
							...
							function focusByLabel(label) {
							    if (domUtils.isElementFocusable(label)) focusBlurSandbox.focus(label, _testcafeCore2.default.noop, false, true);else focusByRelatedElement(label);
							}
				...
				"core": {
					...
					"utils": {
						...
						"dom.js": function (exports, module, require) {
							...
							var isLabelElement = exports.isLabelElement = _hammerhead2.default.utils.dom.isLabelElement;
							var isSelectElement = exports.isSelectElement = _hammerhead2.default.utils.dom.isSelectElement;
							var isRadioButtonElement = exports.isRadioButtonElement = _hammerhead2.default.utils.dom.isRadioButtonElement;
							var isColorInputElement = exports.isColorInputElement = _hammerhead2.default.utils.dom.isColorInputElement;
							var isCheckboxElement = exports.isCheckboxElement = _hammerhead2.default.utils.dom.isCheckboxElement;
							...
							var findParent = exports.findParent = _hammerhead2.default.utils.dom.findParent;
							...
							function isElementContainsNode(parentElement, childNode) {
							    if (isTheSameNode(childNode, parentElement)) return true;
							    ...
							    for (var i = 0; i < length; i++) {
							        ...
							        if (!isShadowUIElement(el) && isElementContainsNode(el, childNode)) return true;
							    }
							...
							function hasBodyScroll(el) {
							    ...
							    if (browserUtils.isChrome || browserUtils.isFirefox) {
							        var _el$getBoundingClient = el.getBoundingClientRect(),
							            bodyTop = _el$getBoundingClient.top;

							        var _documentElement$getB = documentElement.getBoundingClientRect(),
							            documentTop = _documentElement$getB.top;

							        bodyScrollHeight = bodyScrollHeight - documentTop + bodyTop;
							    }

							    return (scrollableHorizontally || scrollableVertically) && bodyScrollHeight > documentElement.scrollHeight;
							}
			...
			"errors": {
				"test-run": {
					"index.js": function (exports, module, require) {
						...
						// Base
						//--------------------------------------------------------------------
						var TestRunErrorBase = function TestRunErrorBase(code) {
						...
						var ActionOptionErrorBase = function (_TestRunErrorBase) {
						    ...
						    function ActionOptionErrorBase(code, optionName, actualValue) {
						        ...
						        var _this = _possibleConstructorReturn(this, _TestRunErrorBase.call(this, code));
						...
						var ActionArgumentErrorBase = function (_TestRunErrorBase2) {
						    ...
						    function ActionArgumentErrorBase(code, argumentName, actualValue) {
						        ...
						        var _this2 = _possibleConstructorReturn(this, _TestRunErrorBase2.call(this, code));
						...
						var MissingAwaitError = exports.MissingAwaitError = function (_TestRunErrorBase3) {
						    ...
						    function MissingAwaitError(callsite) {
						        ...
						        var _this3 = _possibleConstructorReturn(this, _TestRunErrorBase3.call(this, _types.TEST_RUN_ERRORS.missingAwaitError));
						...
						var ClientFunctionExecutionInterruptionError = exports.ClientFunctionExecutionInterruptionError = function (_TestRunErrorBase4) {
						    ...
						    function ClientFunctionExecutionInterruptionError(instantiationCallsiteName) {
						        ...
						        var _this4 = _possibleConstructorReturn(this, _TestRunErrorBase4.call(this, _types.TEST_RUN_ERRORS.clientFunctionExecutionInterruptionError));
						...
						var DomNodeClientFunctionResultError = exports.DomNodeClientFunctionResultError = function (_TestRunErrorBase5) {
						    ...
						    function DomNodeClientFunctionResultError(instantiationCallsiteName) {
						        ...
						        var _this5 = _possibleConstructorReturn(this, _TestRunErrorBase5.call(this, _types.TEST_RUN_ERRORS.domNodeClientFunctionResultError));
						...
						var SelectorErrorBase = function (_TestRunErrorBase6) {
						    ...
						    function SelectorErrorBase(code, _ref) {
						        var apiFnChain = _ref.apiFnChain,
						            apiFnIndex = _ref.apiFnIndex;

						        _classCallCheck(this, SelectorErrorBase);

						        var _this6 = _possibleConstructorReturn(this, _TestRunErrorBase6.call(this, code));
						...
						var InvalidSelectorResultError = exports.InvalidSelectorResultError = function (_TestRunErrorBase7) {
						    ...
						    function InvalidSelectorResultError() {
						        ...
						        return _possibleConstructorReturn(this, _TestRunErrorBase7.call(this, _types.TEST_RUN_ERRORS.invalidSelectorResultError));
						    }

						    return InvalidSelectorResultError;
						}(TestRunErrorBase);

						var CannotObtainInfoForElementSpecifiedBySelectorError = exports.CannotObtainInfoForElementSpecifiedBySelectorError = function (_SelectorErrorBase) {
						    _inherits(CannotObtainInfoForElementSpecifiedBySelectorError, _SelectorErrorBase);

						    function CannotObtainInfoForElementSpecifiedBySelectorError(callsite, apiFnArgs) {
						        _classCallCheck(this, CannotObtainInfoForElementSpecifiedBySelectorError);

						        var _this8 = _possibleConstructorReturn(this, _SelectorErrorBase.call(this, _types.TEST_RUN_ERRORS.cannotObtainInfoForElementSpecifiedBySelectorError, apiFnArgs));
						...
						var PageLoadError = exports.PageLoadError = function (_TestRunErrorBase8) {
						    ...
						    function PageLoadError(errMsg, url) {
						        ...
						        var _this9 = _possibleConstructorReturn(this, _TestRunErrorBase8.call(this, _types.TEST_RUN_ERRORS.pageLoadError));
						...
						var UncaughtErrorOnPage = exports.UncaughtErrorOnPage = function (_TestRunErrorBase9) {
						    ...
						    function UncaughtErrorOnPage(errStack, pageDestUrl) {
						        ...
						        var _this10 = _possibleConstructorReturn(this, _TestRunErrorBase9.call(this, _types.TEST_RUN_ERRORS.uncaughtErrorOnPage));
						...
						var UncaughtErrorInTestCode = exports.UncaughtErrorInTestCode = function (_TestRunErrorBase10) {
						    ...
						    function UncaughtErrorInTestCode(err, callsite) {
						        ...
						        var _this11 = _possibleConstructorReturn(this, _TestRunErrorBase10.call(this, _types.TEST_RUN_ERRORS.uncaughtErrorInTestCode));

						        _this11.errMsg = String(err.rawMessage || err);
						        _this11.callsite = err.callsite || callsite;
						        _this11.originError = err;
						        return _this11;
						    }
						...
						var UncaughtNonErrorObjectInTestCode = exports.UncaughtNonErrorObjectInTestCode = function (_TestRunErrorBase11) {
						    ...
						    function UncaughtNonErrorObjectInTestCode(obj) {
						        ...
						        var _this12 = _possibleConstructorReturn(this, _TestRunErrorBase11.call(this, _types.TEST_RUN_ERRORS.uncaughtNonErrorObjectInTestCode));
						...
						var UncaughtErrorInClientFunctionCode = exports.UncaughtErrorInClientFunctionCode = function (_TestRunErrorBase12) {
						    ...
						    function UncaughtErrorInClientFunctionCode(instantiationCallsiteName, err) {
						        ...
						        var _this13 = _possibleConstructorReturn(this, _TestRunErrorBase12.call(this, _types.TEST_RUN_ERRORS.uncaughtErrorInClientFunctionCode));
						...
						var UncaughtErrorInCustomDOMPropertyCode = exports.UncaughtErrorInCustomDOMPropertyCode = function (_TestRunErrorBase13) {
						    ...
						    function UncaughtErrorInCustomDOMPropertyCode(instantiationCallsiteName, err, prop) {
						        ...
						        var _this14 = _possibleConstructorReturn(this, _TestRunErrorBase13.call(this, _types.TEST_RUN_ERRORS.uncaughtErrorInCustomDOMPropertyCode, err, prop));
						...
						var UnhandledPromiseRejectionError = exports.UnhandledPromiseRejectionError = function (_TestRunErrorBase14) {
						    ...
						    function UnhandledPromiseRejectionError(err) {
						        ...
						        var _this15 = _possibleConstructorReturn(this, _TestRunErrorBase14.call(this, _types.TEST_RUN_ERRORS.unhandledPromiseRejection));
						...
						var UncaughtExceptionError = exports.UncaughtExceptionError = function (_TestRunErrorBase15) {
						    ...
						    function UncaughtExceptionError(err) {
						        ...
						        var _this16 = _possibleConstructorReturn(this, _TestRunErrorBase15.call(this, _types.TEST_RUN_ERRORS.uncaughtException));
						...
						var UncaughtErrorInCustomClientScriptCode = exports.UncaughtErrorInCustomClientScriptCode = function (_TestRunErrorBase16) {
						    _inherits(UncaughtErrorInCustomClientScriptCode, _TestRunErrorBase16);

						    function UncaughtErrorInCustomClientScriptCode(err) {
						        _classCallCheck(this, UncaughtErrorInCustomClientScriptCode);

						        var _this17 = _possibleConstructorReturn(this, _TestRunErrorBase16.call(this, _types.TEST_RUN_ERRORS.uncaughtErrorInCustomClientScriptCode));
						...
						var UncaughtErrorInCustomClientScriptLoadedFromModule = exports.UncaughtErrorInCustomClientScriptLoadedFromModule = function (_TestRunErrorBase17) {
						    _inherits(UncaughtErrorInCustomClientScriptLoadedFromModule, _TestRunErrorBase17);

						    function UncaughtErrorInCustomClientScriptLoadedFromModule(err, moduleName) {
						        _classCallCheck(this, UncaughtErrorInCustomClientScriptLoadedFromModule);

						        var _this18 = _possibleConstructorReturn(this, _TestRunErrorBase17.call(this, _types.TEST_RUN_ERRORS.uncaughtErrorInCustomClientScriptCodeLoadedFromModule));

						        _this18.errMsg = String(err);
						        _this18.moduleName = moduleName;
						        return _this18;
						    }
						...
						var ExternalAssertionLibraryError = exports.ExternalAssertionLibraryError = function (_TestRunErrorBase18) {
						    _inherits(ExternalAssertionLibraryError, _TestRunErrorBase18);

						    function ExternalAssertionLibraryError(err, callsite) {
						        _classCallCheck(this, ExternalAssertionLibraryError);

						        var _this19 = _possibleConstructorReturn(this, _TestRunErrorBase18.call(this, _types.TEST_RUN_ERRORS.externalAssertionLibraryError));

						        _this19.errMsg = String(err);
						...
						var AssertionExecutableArgumentError = exports.AssertionExecutableArgumentError = function (_ActionArgumentErrorB) {
						    ...
						    function AssertionExecutableArgumentError(argumentName, argumentValue, err, isAPIError) {
						        ...
						        var _this20 = _possibleConstructorReturn(this, _ActionArgumentErrorB.call(this, _types.TEST_RUN_ERRORS.assertionExecutableArgumentError, argumentName, argumentValue));

						        _this20.errMsg = isAPIError ? err.rawMessage : err.message;
						        _this20.originError = err;
						        return _this20;
						    }
						...
						var AssertionWithoutMethodCallError = exports.AssertionWithoutMethodCallError = function (_TestRunErrorBase19) {
						    _inherits(AssertionWithoutMethodCallError, _TestRunErrorBase19);

						    function AssertionWithoutMethodCallError(callsite) {
						        _classCallCheck(this, AssertionWithoutMethodCallError);

						        var _this21 = _possibleConstructorReturn(this, _TestRunErrorBase19.call(this, _types.TEST_RUN_ERRORS.assertionWithoutMethodCallError));

						        _this21.callsite = callsite;
						        return _this21;
						    }
						...
						var AssertionUnawaitedPromiseError = exports.AssertionUnawaitedPromiseError = function (_TestRunErrorBase20) {
						    _inherits(AssertionUnawaitedPromiseError, _TestRunErrorBase20);

						    function AssertionUnawaitedPromiseError(callsite) {
						        _classCallCheck(this, AssertionUnawaitedPromiseError);

						        var _this22 = _possibleConstructorReturn(this, _TestRunErrorBase20.call(this, _types.TEST_RUN_ERRORS.assertionUnawaitedPromiseError));

						        _this22.callsite = callsite;
						        return _this22;
						    }
						...
						var ActionIntegerOptionError = exports.ActionIntegerOptionError = function (_ActionOptionErrorBas) {
						    ...
						    function ActionIntegerOptionError(optionName, actualValue) {
						        ...
						        return _possibleConstructorReturn(this, _ActionOptionErrorBas.call(this, _types.TEST_RUN_ERRORS.actionIntegerOptionError, optionName, actualValue));
						    }
						...
						var ActionPositiveIntegerOptionError = exports.ActionPositiveIntegerOptionError = function (_ActionOptionErrorBas2) {
						    ...
						    function ActionPositiveIntegerOptionError(optionName, actualValue) {
						        ...
						        return _possibleConstructorReturn(this, _ActionOptionErrorBas2.call(this, _types.TEST_RUN_ERRORS.actionPositiveIntegerOptionError, optionName, actualValue));
						    }
						...
						var ActionBooleanOptionError = exports.ActionBooleanOptionError = function (_ActionOptionErrorBas3) {
						    ...
						    function ActionBooleanOptionError(optionName, actualValue) {
						        ...
						        return _possibleConstructorReturn(this, _ActionOptionErrorBas3.call(this, _types.TEST_RUN_ERRORS.actionBooleanOptionError, optionName, actualValue));
						    }
						...
						var ActionBooleanArgumentError = exports.ActionBooleanArgumentError = function (_ActionArgumentErrorB2) {
						    ...
						    function ActionBooleanArgumentError(argumentName, actualValue) {
						        ...
						        return _possibleConstructorReturn(this, _ActionArgumentErrorB2.call(this, _types.TEST_RUN_ERRORS.actionBooleanArgumentError, argumentName, actualValue));
						    }
						...
						var ActionSpeedOptionError = exports.ActionSpeedOptionError = function (_ActionOptionErrorBas4) {
						    ...
						    function ActionSpeedOptionError(optionName, actualValue) {
						        ...
						        return _possibleConstructorReturn(this, _ActionOptionErrorBas4.call(this, _types.TEST_RUN_ERRORS.actionSpeedOptionError, optionName, actualValue));
						    }

						    return ActionSpeedOptionError;
						}(ActionOptionErrorBase);

						var ActionOptionsTypeError = exports.ActionOptionsTypeError = function (_TestRunErrorBase21) {
						    _inherits(ActionOptionsTypeError, _TestRunErrorBase21);

						    function ActionOptionsTypeError(actualType) {
						        _classCallCheck(this, ActionOptionsTypeError);

						        var _this28 = _possibleConstructorReturn(this, _TestRunErrorBase21.call(this, _types.TEST_RUN_ERRORS.actionOptionsTypeError));

						        _this28.actualType = actualType;
						        return _this28;
						    }
						...
						var ActionStringArgumentError = exports.ActionStringArgumentError = function (_ActionArgumentErrorB3) {
						    ...
						    function ActionStringArgumentError(argumentName, actualValue) {
						        ...
						        return _possibleConstructorReturn(this, _ActionArgumentErrorB3.call(this, _types.TEST_RUN_ERRORS.actionStringArgumentError, argumentName, actualValue));
						    }
						...
						var ActionNullableStringArgumentError = exports.ActionNullableStringArgumentError = function (_ActionArgumentErrorB4) {
						    ...
						    function ActionNullableStringArgumentError(argumentName, actualValue) {
						        ...
						        return _possibleConstructorReturn(this, _ActionArgumentErrorB4.call(this, _types.TEST_RUN_ERRORS.actionNullableStringArgumentError, argumentName, actualValue));
						    }
						...
						var ActionIntegerArgumentError = exports.ActionIntegerArgumentError = function (_ActionArgumentErrorB5) {
						    ...
						    function ActionIntegerArgumentError(argumentName, actualValue) {
						        ...
						        return _possibleConstructorReturn(this, _ActionArgumentErrorB5.call(this, _types.TEST_RUN_ERRORS.actionIntegerArgumentError, argumentName, actualValue));
						    }
						...
						var ActionRoleArgumentError = exports.ActionRoleArgumentError = function (_ActionArgumentErrorB6) {
						    ...
						    function ActionRoleArgumentError(argumentName, actualValue) {
						        ...
						        return _possibleConstructorReturn(this, _ActionArgumentErrorB6.call(this, _types.TEST_RUN_ERRORS.actionRoleArgumentError, argumentName, actualValue));
						    }
						...
						var ActionPositiveIntegerArgumentError = exports.ActionPositiveIntegerArgumentError = function (_ActionArgumentErrorB7) {
						    ...
						    function ActionPositiveIntegerArgumentError(argumentName, actualValue) {
						        ...
						        return _possibleConstructorReturn(this, _ActionArgumentErrorB7.call(this, _types.TEST_RUN_ERRORS.actionPositiveIntegerArgumentError, argumentName, actualValue));
						    }
						...
						var ActionStringOrStringArrayArgumentError = exports.ActionStringOrStringArrayArgumentError = function (_ActionArgumentErrorB8) {
						    ...
						    function ActionStringOrStringArrayArgumentError(argumentName, actualValue) {
						        ...
						        return _possibleConstructorReturn(this, _ActionArgumentErrorB8.call(this, _types.TEST_RUN_ERRORS.actionStringOrStringArrayArgumentError, argumentName, actualValue));
						    }
						...
						var ActionStringArrayElementError = exports.ActionStringArrayElementError = function (_ActionArgumentErrorB9) {
						    ...
						    function ActionStringArrayElementError(argumentName, actualValue, elementIndex) {
						        ...
						        var _this35 = _possibleConstructorReturn(this, _ActionArgumentErrorB9.call(this, _types.TEST_RUN_ERRORS.actionStringArrayElementError, argumentName, actualValue));

						        _this35.elementIndex = elementIndex;
						        return _this35;
						    }
						...
						var SetTestSpeedArgumentError = exports.SetTestSpeedArgumentError = function (_ActionArgumentErrorB10) {
						    ...
						    function SetTestSpeedArgumentError(argumentName, actualValue) {
						        ...
						        return _possibleConstructorReturn(this, _ActionArgumentErrorB10.call(this, _types.TEST_RUN_ERRORS.setTestSpeedArgumentError, argumentName, actualValue));
						    }
						...
						var ActionUnsupportedDeviceTypeError = exports.ActionUnsupportedDeviceTypeError = function (_ActionArgumentErrorB11) {
						    ...
						    function ActionUnsupportedDeviceTypeError(argumentName, argumentValue) {
						        ...
						        return _possibleConstructorReturn(this, _ActionArgumentErrorB11.call(this, _types.TEST_RUN_ERRORS.actionUnsupportedDeviceTypeError, argumentName, argumentValue));
						    }
						...
						var ActionSelectorError = exports.ActionSelectorError = function (_TestRunErrorBase22) {
						    _inherits(ActionSelectorError, _TestRunErrorBase22);

						    function ActionSelectorError(selectorName, err, isAPIError) {
						        _classCallCheck(this, ActionSelectorError);

						        var _this38 = _possibleConstructorReturn(this, _TestRunErrorBase22.call(this, _types.TEST_RUN_ERRORS.actionSelectorError));

						        _this38.selectorName = selectorName;
						        _this38.errMsg = isAPIError ? err.rawMessage : err.message;
						        _this38.originError = err;
						        return _this38;
						    }
						...
						var ActionElementNotFoundError = exports.ActionElementNotFoundError = function (_SelectorErrorBase2) {
						    ...
						    function ActionElementNotFoundError(apiFnArgs) {
						        ...
						        return _possibleConstructorReturn(this, _SelectorErrorBase2.call(this, _types.TEST_RUN_ERRORS.actionElementNotFoundError, apiFnArgs));
						    }

						    return ActionElementNotFoundError;
						}(SelectorErrorBase);

						var ActionElementIsInvisibleError = exports.ActionElementIsInvisibleError = function (_TestRunErrorBase23) {
						    _inherits(ActionElementIsInvisibleError, _TestRunErrorBase23);

						    function ActionElementIsInvisibleError() {
						        _classCallCheck(this, ActionElementIsInvisibleError);

						        return _possibleConstructorReturn(this, _TestRunErrorBase23.call(this, _types.TEST_RUN_ERRORS.actionElementIsInvisibleError));
						    }

						    return ActionElementIsInvisibleError;
						}(TestRunErrorBase);

						var ActionSelectorMatchesWrongNodeTypeError = exports.ActionSelectorMatchesWrongNodeTypeError = function (_TestRunErrorBase24) {
						    _inherits(ActionSelectorMatchesWrongNodeTypeError, _TestRunErrorBase24);
						    ...
						    function ActionSelectorMatchesWrongNodeTypeError(nodeDescription) {
						        ...
						        var _this41 = _possibleConstructorReturn(this, _TestRunErrorBase24.call(this, _types.TEST_RUN_ERRORS.actionSelectorMatchesWrongNodeTypeError));

						        _this41.nodeDescription = nodeDescription;
						        return _this41;
						    }
						...
						var ActionAdditionalElementNotFoundError = exports.ActionAdditionalElementNotFoundError = function (_SelectorErrorBase3) {
						    ...
						    function ActionAdditionalElementNotFoundError(argumentName, apiFnArgs) {
						        ...
						        var _this42 = _possibleConstructorReturn(this, _SelectorErrorBase3.call(this, _types.TEST_RUN_ERRORS.actionAdditionalElementNotFoundError, apiFnArgs));
						...
						var ActionAdditionalElementIsInvisibleError = exports.ActionAdditionalElementIsInvisibleError = function (_TestRunErrorBase25) {
						    _inherits(ActionAdditionalElementIsInvisibleError, _TestRunErrorBase25);
						    ...
						    function ActionAdditionalElementIsInvisibleError(argumentName) {
						        ...
						        var _this43 = _possibleConstructorReturn(this, _TestRunErrorBase25.call(this, _types.TEST_RUN_ERRORS.actionAdditionalElementIsInvisibleError));

						        _this43.argumentName = argumentName;
						        return _this43;
						    }
						...
						var ActionAdditionalSelectorMatchesWrongNodeTypeError = exports.ActionAdditionalSelectorMatchesWrongNodeTypeError = function (_TestRunErrorBase26) {
						    _inherits(ActionAdditionalSelectorMatchesWrongNodeTypeError, _TestRunErrorBase26);
						    ...
						    function ActionAdditionalSelectorMatchesWrongNodeTypeError(argumentName, nodeDescription) {
						        ...
						        var _this44 = _possibleConstructorReturn(this, _TestRunErrorBase26.call(this, _types.TEST_RUN_ERRORS.actionAdditionalSelectorMatchesWrongNodeTypeError));

						        _this44.argumentName = argumentName;
						        _this44.nodeDescription = nodeDescription;
						        return _this44;
						    }
						...
						var ActionElementNonEditableError = exports.ActionElementNonEditableError = function (_TestRunErrorBase27) {
						    _inherits(ActionElementNonEditableError, _TestRunErrorBase27);

						    function ActionElementNonEditableError() {
						        _classCallCheck(this, ActionElementNonEditableError);

						        return _possibleConstructorReturn(this, _TestRunErrorBase27.call(this, _types.TEST_RUN_ERRORS.actionElementNonEditableError));
						    }

						    return ActionElementNonEditableError;
						}(TestRunErrorBase);

						var ActionElementNotTextAreaError = exports.ActionElementNotTextAreaError = function (_TestRunErrorBase28) {
						    _inherits(ActionElementNotTextAreaError, _TestRunErrorBase28);

						    function ActionElementNotTextAreaError() {
						        _classCallCheck(this, ActionElementNotTextAreaError);

						        return _possibleConstructorReturn(this, _TestRunErrorBase28.call(this, _types.TEST_RUN_ERRORS.actionElementNotTextAreaError));
						    }

						    return ActionElementNotTextAreaError;
						}(TestRunErrorBase);

						var ActionElementNonContentEditableError = exports.ActionElementNonContentEditableError = function (_TestRunErrorBase29) {
						    _inherits(ActionElementNonContentEditableError, _TestRunErrorBase29);

						    function ActionElementNonContentEditableError(argumentName) {
						        _classCallCheck(this, ActionElementNonContentEditableError);

						        var _this47 = _possibleConstructorReturn(this, _TestRunErrorBase29.call(this, _types.TEST_RUN_ERRORS.actionElementNonContentEditableError));
						...
						var ActionRootContainerNotFoundError = exports.ActionRootContainerNotFoundError = function (_TestRunErrorBase30) {
						    _inherits(ActionRootContainerNotFoundError, _TestRunErrorBase30);

						    function ActionRootContainerNotFoundError() {
						        _classCallCheck(this, ActionRootContainerNotFoundError);

						        return _possibleConstructorReturn(this, _TestRunErrorBase30.call(this, _types.TEST_RUN_ERRORS.actionRootContainerNotFoundError));
						    }

						    return ActionRootContainerNotFoundError;
						}(TestRunErrorBase);

						var ActionIncorrectKeysError = exports.ActionIncorrectKeysError = function (_TestRunErrorBase31) {
						    _inherits(ActionIncorrectKeysError, _TestRunErrorBase31);

						    function ActionIncorrectKeysError(argumentName) {
						        _classCallCheck(this, ActionIncorrectKeysError);

						        var _this49 = _possibleConstructorReturn(this, _TestRunErrorBase31.call(this, _types.TEST_RUN_ERRORS.actionIncorrectKeysError));

						        _this49.argumentName = argumentName;
						        return _this49;
						    }
						...
						var ActionCannotFindFileToUploadError = exports.ActionCannotFindFileToUploadError = function (_TestRunErrorBase32) {
						    _inherits(ActionCannotFindFileToUploadError, _TestRunErrorBase32);

						    function ActionCannotFindFileToUploadError(filePaths) {
						        _classCallCheck(this, ActionCannotFindFileToUploadError);

						        var _this50 = _possibleConstructorReturn(this, _TestRunErrorBase32.call(this, _types.TEST_RUN_ERRORS.actionCannotFindFileToUploadError));

						        _this50.filePaths = filePaths;
						        return _this50;
						    }
						...
						var ActionElementIsNotFileInputError = exports.ActionElementIsNotFileInputError = function (_TestRunErrorBase33) {
						    _inherits(ActionElementIsNotFileInputError, _TestRunErrorBase33);

						    function ActionElementIsNotFileInputError() {
						        _classCallCheck(this, ActionElementIsNotFileInputError);

						        return _possibleConstructorReturn(this, _TestRunErrorBase33.call(this, _types.TEST_RUN_ERRORS.actionElementIsNotFileInputError));
						    }

						    return ActionElementIsNotFileInputError;
						}(TestRunErrorBase);

						var ActionInvalidScrollTargetError = exports.ActionInvalidScrollTargetError = function (_TestRunErrorBase34) {
						    _inherits(ActionInvalidScrollTargetError, _TestRunErrorBase34);
						    ...
						    function ActionInvalidScrollTargetError(scrollTargetXValid, scrollTargetYValid) {
						        ...
						        var _this52 = _possibleConstructorReturn(this, _TestRunErrorBase34.call(this, _types.TEST_RUN_ERRORS.actionInvalidScrollTargetError));

						        if (!scrollTargetXValid) {
						            if (!scrollTargetYValid) _this52.properties = 'scrollTargetX and scrollTargetY properties';else _this52.properties = 'scrollTargetX property';
						        } else _this52.properties = 'scrollTargetY property';
						        return _this52;
						    }
						...
						var ExecuteAsyncExpressionError = exports.ExecuteAsyncExpressionError = function (_TestRunErrorBase35) {
						    _inherits(ExecuteAsyncExpressionError, _TestRunErrorBase35);

						    function ExecuteAsyncExpressionError(err, expression, line, column, callsite) {
						        _classCallCheck(this, ExecuteAsyncExpressionError);

						        var _this53 = _possibleConstructorReturn(this, _TestRunErrorBase35.call(this, _types.TEST_RUN_ERRORS.executeAsyncExpressionError));

						        _this53.errMsg = err.message;
						        _this53.callsite = callsite;
						        _this53.errStack = err.stack;
						        _this53.expression = expression;
						        _this53.line = line;
						        _this53.column = column;
						        return _this53;
						    }

						    return ExecuteAsyncExpressionError;
						}(TestRunErrorBase);

						var WindowDimensionsOverflowError = exports.WindowDimensionsOverflowError = function (_TestRunErrorBase36) {
						    _inherits(WindowDimensionsOverflowError, _TestRunErrorBase36);

						    function WindowDimensionsOverflowError(callsite) {
						        _classCallCheck(this, WindowDimensionsOverflowError);

						        var _this54 = _possibleConstructorReturn(this, _TestRunErrorBase36.call(this, _types.TEST_RUN_ERRORS.windowDimensionsOverflowError));
						...
						var InvalidElementScreenshotDimensionsError = exports.InvalidElementScreenshotDimensionsError = function (_TestRunErrorBase37) {
						    _inherits(InvalidElementScreenshotDimensionsError, _TestRunErrorBase37);
						    ...
						    function InvalidElementScreenshotDimensionsError(width, height) {
						        ...
						        var _this55 = _possibleConstructorReturn(this, _TestRunErrorBase37.call(this, _types.TEST_RUN_ERRORS.invalidElementScreenshotDimensionsError));
						        ...
						        if (widthIsInvalid) {
						            if (heightIsInvalid) {
						                _this55.verb = 'are';
						                _this55.dimensions = 'width and height';
						            } else {
						                _this55.verb = 'is';
						                _this55.dimensions = 'width';
						            }
						        } else {
						            _this55.verb = 'is';
						            _this55.dimensions = 'height';
						        }
						        return _this55;
						    }
						...
						var ForbiddenCharactersInScreenshotPathError = exports.ForbiddenCharactersInScreenshotPathError = function (_TestRunErrorBase38) {
						    _inherits(ForbiddenCharactersInScreenshotPathError, _TestRunErrorBase38);
						    ...
						    function ForbiddenCharactersInScreenshotPathError(screenshotPath, forbiddenCharsList) {
						        ...
						        var _this56 = _possibleConstructorReturn(this, _TestRunErrorBase38.call(this, _types.TEST_RUN_ERRORS.forbiddenCharactersInScreenshotPathError));

						        _this56.screenshotPath = screenshotPath;
						        _this56.forbiddenCharsList = forbiddenCharsList;
						        return _this56;
						    }
						...
						var RoleSwitchInRoleInitializerError = exports.RoleSwitchInRoleInitializerError = function (_TestRunErrorBase39) {
						    _inherits(RoleSwitchInRoleInitializerError, _TestRunErrorBase39);

						    function RoleSwitchInRoleInitializerError(callsite) {
						        _classCallCheck(this, RoleSwitchInRoleInitializerError);

						        var _this57 = _possibleConstructorReturn(this, _TestRunErrorBase39.call(this, _types.TEST_RUN_ERRORS.roleSwitchInRoleInitializerError));

						        _this57.callsite = callsite;
						        return _this57;
						    }
						...
						var ActionElementNotIframeError = exports.ActionElementNotIframeError = function (_TestRunErrorBase40) {
						    _inherits(ActionElementNotIframeError, _TestRunErrorBase40);

						    function ActionElementNotIframeError() {
						        _classCallCheck(this, ActionElementNotIframeError);

						        return _possibleConstructorReturn(this, _TestRunErrorBase40.call(this, _types.TEST_RUN_ERRORS.actionElementNotIframeError));
						    }

						    return ActionElementNotIframeError;
						}(TestRunErrorBase);

						var ActionIframeIsNotLoadedError = exports.ActionIframeIsNotLoadedError = function (_TestRunErrorBase41) {
						    _inherits(ActionIframeIsNotLoadedError, _TestRunErrorBase41);

						    function ActionIframeIsNotLoadedError() {
						        _classCallCheck(this, ActionIframeIsNotLoadedError);

						        return _possibleConstructorReturn(this, _TestRunErrorBase41.call(this, _types.TEST_RUN_ERRORS.actionIframeIsNotLoadedError));
						    }

						    return ActionIframeIsNotLoadedError;
						}(TestRunErrorBase);

						var CurrentIframeIsNotLoadedError = exports.CurrentIframeIsNotLoadedError = function (_TestRunErrorBase42) {
						    _inherits(CurrentIframeIsNotLoadedError, _TestRunErrorBase42);

						    function CurrentIframeIsNotLoadedError() {
						        _classCallCheck(this, CurrentIframeIsNotLoadedError);

						        return _possibleConstructorReturn(this, _TestRunErrorBase42.call(this, _types.TEST_RUN_ERRORS.currentIframeIsNotLoadedError));
						    }

						    return CurrentIframeIsNotLoadedError;
						}(TestRunErrorBase);

						var CurrentIframeNotFoundError = exports.CurrentIframeNotFoundError = function (_TestRunErrorBase43) {
						    _inherits(CurrentIframeNotFoundError, _TestRunErrorBase43);

						    function CurrentIframeNotFoundError() {
						        _classCallCheck(this, CurrentIframeNotFoundError);

						        return _possibleConstructorReturn(this, _TestRunErrorBase43.call(this, _types.TEST_RUN_ERRORS.currentIframeNotFoundError));
						    }

						    return CurrentIframeNotFoundError;
						}(TestRunErrorBase);

						var CurrentIframeIsInvisibleError = exports.CurrentIframeIsInvisibleError = function (_TestRunErrorBase44) {
						    _inherits(CurrentIframeIsInvisibleError, _TestRunErrorBase44);

						    function CurrentIframeIsInvisibleError() {
						        _classCallCheck(this, CurrentIframeIsInvisibleError);

						        return _possibleConstructorReturn(this, _TestRunErrorBase44.call(this, _types.TEST_RUN_ERRORS.currentIframeIsInvisibleError));
						    }
						...
						var NativeDialogNotHandledError = exports.NativeDialogNotHandledError = function (_TestRunErrorBase45) {
						    _inherits(NativeDialogNotHandledError, _TestRunErrorBase45);

						    function NativeDialogNotHandledError(dialogType, url) {
						        _classCallCheck(this, NativeDialogNotHandledError);

						        var _this63 = _possibleConstructorReturn(this, _TestRunErrorBase45.call(this, _types.TEST_RUN_ERRORS.nativeDialogNotHandledError));

						        _this63.dialogType = dialogType;
						        _this63.pageUrl = url;
						        return _this63;
						    }
						...
						var UncaughtErrorInNativeDialogHandler = exports.UncaughtErrorInNativeDialogHandler = function (_TestRunErrorBase46) {
						    _inherits(UncaughtErrorInNativeDialogHandler, _TestRunErrorBase46);

						    function UncaughtErrorInNativeDialogHandler(dialogType, errMsg, url) {
						        _classCallCheck(this, UncaughtErrorInNativeDialogHandler);

						        var _this64 = _possibleConstructorReturn(this, _TestRunErrorBase46.call(this, _types.TEST_RUN_ERRORS.uncaughtErrorInNativeDialogHandler));

						        _this64.dialogType = dialogType;
						        _this64.errMsg = errMsg;
						        _this64.pageUrl = url;
						        return _this64;
						    }
						...
						var SetNativeDialogHandlerCodeWrongTypeError = exports.SetNativeDialogHandlerCodeWrongTypeError = function (_TestRunErrorBase47) {
						    _inherits(SetNativeDialogHandlerCodeWrongTypeError, _TestRunErrorBase47);
						    ...
						    function SetNativeDialogHandlerCodeWrongTypeError(actualType) {
						        ...
						        var _this65 = _possibleConstructorReturn(this, _TestRunErrorBase47.call(this, _types.TEST_RUN_ERRORS.setNativeDialogHandlerCodeWrongTypeError));

						        _this65.actualType = actualType;
						        return _this65;
						    }
						...
						var RequestHookUnhandledError = exports.RequestHookUnhandledError = function (_TestRunErrorBase48) {
						    _inherits(RequestHookUnhandledError, _TestRunErrorBase48);

						    function RequestHookUnhandledError(err, hookClassName, methodName) {
						        _classCallCheck(this, RequestHookUnhandledError);

						        var _this66 = _possibleConstructorReturn(this, _TestRunErrorBase48.call(this, _types.TEST_RUN_ERRORS.requestHookUnhandledError));

						        _this66.errMsg = String(err);
						        _this66.hookClassName = hookClassName;
						        _this66.methodName = methodName;
						        return _this66;
						    }
						...
						var RequestHookNotImplementedMethodError = exports.RequestHookNotImplementedMethodError = function (_TestRunErrorBase49) {
						    _inherits(RequestHookNotImplementedMethodError, _TestRunErrorBase49);

						    function RequestHookNotImplementedMethodError(methodName, hookClassName) {
						        _classCallCheck(this, RequestHookNotImplementedMethodError);

						        var _this67 = _possibleConstructorReturn(this, _TestRunErrorBase49.call(this, _types.TEST_RUN_ERRORS.requestHookNotImplementedError));

						        _this67.methodName = methodName;
						        _this67.hookClassName = hookClassName;
						        return _this67;
						    }
				...
				"types.js": function (exports, module, require) {
					...
					var TEST_RUN_ERRORS = exports.TEST_RUN_ERRORS = {
					...
					var RUNTIME_ERRORS = exports.RUNTIME_ERRORS = {
